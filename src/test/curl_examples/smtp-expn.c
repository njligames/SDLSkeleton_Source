...
// int main(void)
{
    ...
    if (curl) {
         ...
         * may not be a good idea to keep the connection open for a very long
         * time though (more than a few minutes may result in the server timing
         * out the connection) and you do want to clean up in the end.
         */
