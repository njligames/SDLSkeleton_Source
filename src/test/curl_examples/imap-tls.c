...
// int main(void)
{
    ...
    if (curl) {
         ...
         * upgrade to Transport Layer Security (TLS) using the STARTTLS command.
         * Be careful of using CURLUSESSL_TRY here, because if TLS upgrade
         * fails, the transfer will continue anyway - see the security
