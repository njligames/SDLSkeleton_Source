...
// int CurlExample::test_anyauthput(const std::vector<std::string>>
// &args){return anyauthput(argc, argv);}
int CurlExample::test_certinfo(void) { return certinfo(); }
// int CurlExample::test_chkspeed(const std::vector<std::string>> &args){return
// chkspeed(argc, argv);}
int CurlExample::test_cookie_interface(void) { return cookie_interface(); }
// int CurlExample::test_curlx(const std::vector<std::string>> &args){return
// curlx(argc, argv);}
...
// int CurlExample::test_fopen(const std::vector<std::string>> &args){return
// _fopen(argc, argv);} int CurlExample::test_ftp_wildcard(const
// std::vector<std::string>> &args){return ftp_wildcard(argc, argv);}
...
// int CurlExample::test_http2_download(const std::vector<std::string>>
// &args){return http2_download(argc, argv);}
...
// int CurlExample::test_http2_upload(const std::vector<std::string>>
// &args){return http2_upload(argc, argv);}
int CurlExample::test_httpcustomheader(void) { return httpcustomheader(); }
// int CurlExample::test_httpput(const std::vector<std::string>> &args){return
// httpput(argc, argv);}
...
int CurlExample::test_multi_debugcallback(void) {
    return multi_debugcallback();
}
...
// int CurlExample::test_multithread(const std::vector<std::string>>
// &args){return multithread(argc, argv);}
...
// int CurlExample::test_postit2_formadd(const std::vector<std::string>>
// &args){return postit2_formadd(argc, argv);}
int CurlExample::test_resolve(void) { return resolve(); }
// int CurlExample::test_rtsp(const std::vector<std::string>> &args){return
// rtsp(argc, argv);}
...
int CurlExample::test_shared_connection_cache(void) {
    return shared_connection_cache();
}
...
int CurlExample::test_threaded_shared_conn(void) {
    return threaded_shared_conn();
}
// int CurlExample::test_threaded_ssl(const std::vector<std::string>>
// &args){return threaded_ssl(argc, argv);} int CurlExample::test_url2file(const
// std::vector<std::string>> &args){return url2file(argc, argv);}
