...
// int main(void)
{
    ...
    if (curl) {
        ...
        /* Note that to perform a move operation you will need to perform the
         * copy, then mark the original mail as Deleted and EXPUNGE or CLOSE.
         * Please see imap-store.c for more information on deleting messages. */
